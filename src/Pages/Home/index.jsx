  ...
  async function buscarPacote() {
    try {
      const { data, status } = await api.get("/postagem/" + codigoRastreio, {
        bearerToken:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNsdnR0d2t1ZDAwMDB0N3FuaHFzdXg4dWQiLCJpYXQiOjE3MTQ5MzE0NTAsImV4cCI6MTcxNTAxNzg1MH0.8WrbvRAtJQQW7_Bkeg86RmN1CWztcc2oQ25VktMdSDA",
      });
      if (status === 200) {
